...
// start on whichever tab the page marked "on", so the lens sits under it on load
let index = Math.max(0, tabs.findIndex(t => t.classList.contains('on')));
let pos = index * 100, vel = 0, tgt = pos, raf = null;
